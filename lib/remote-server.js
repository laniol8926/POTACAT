...
`;
  ...
  _buildInlinedHtml(fromTunnel = false) {
    ...
    try {
      ...
      // Shared GPU waterfall (renderer/waterfall.js) — same component the
      // desktop JTCAT/SSTV popouts use, now shared here too instead of
      // ft8RenderWaterfall's own hand-rolled canvas colorer.
